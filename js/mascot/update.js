...
import { camera, controls } from '../view/rig.js?v=20260813-20';
import { ui, mascot, mascotLabel, mascotLabelY, applyMascotScale, mascotFallMaterialStates } from '../core/studio.js?v=20260813-20';
import {
  joystickInput,
  cameraForwardXZ,
  cameraRightXZ,
...
import { activateInstrumentView } from '../view/instrument-view.js?v=20260813-20';
import { moveMascotWithColliders } from './walk.js?v=20260813-20';
import { mascotMove, dance } from './state.js?v=20260813-20';
import { giftReveal, giftCam } from './reveal.js?v=20260813-20';
import { GUITAR_STRUM_ARM_BASE, setDancing, updateMascotDance } from './pose.js?v=20260813-20';
