...
import { prefersReducedMotion } from '../core/quality.js?v=20260808-02';
import { camera, controls } from '../view/rig.js?v=20260808-02';
import { ui, mascot, mascotLabel, mascotLabelY, applyMascotScale, mascotFallMaterialStates } from '../core/studio.js?v=20260808-02';
import {
  joystickInput,
  cameraForwardXZ,
  cameraRightXZ,
...
import { activateInstrumentView } from '../view/instrument-view.js?v=20260808-02';
import { moveMascotWithColliders } from './walk.js?v=20260808-02';
import { mascotMove, dance } from './state.js?v=20260808-02';
import { mascotEditor } from './editor.js?v=20260808-02';
import { GUITAR_STRUM_ARM_BASE, setDancing, updateMascotDance } from './pose.js?v=20260808-02';
