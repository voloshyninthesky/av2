...
import { prefersReducedMotion, params } from '../core/quality.js?v=20260813-23';
import { trackOnce } from '../core/analytics.js?v=20260813-23';
import { camera, controls, CAM_END, TARGET } from '../view/rig.js?v=20260813-23';
import {
  ui, mascot, mascotLabel, audio, fireworks, giftWardrobe,
  applyMascotConfig, applyMascotScale,
} from '../core/studio.js?v=20260813-23';
import { WARDROBE_AJAR, WARDROBE_DOOR_MAX } from '../scene/gift-wardrobe.js?v=20260813-23';
import { bumpHitPulse } from '../scene/effects.js?v=20260813-23';
import { instrumentView } from '../view/instrument-presets.js?v=20260813-23';
import { leaveInstrumentView } from '../view/instrument-view.js?v=20260813-23';
import { settleOnFollowCamera } from '../view/mobile-controls.js?v=20260813-23';
import { resetMascotPose, setDancing } from './pose.js?v=20260813-23';
import { mascotMove } from './state.js?v=20260813-23';
import {
  validateMascotAppearance, mascotCfg, saveMascotConfig, hasSavedMascot,
} from './appearance.js?v=20260813-23';
import { drawMascotGift, GIFT_TIERS_BY_ID } from './gift.js?v=20260813-23';
