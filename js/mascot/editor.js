...
import { ui, mascot, mascotLabel, instruments, applyMascotConfig } from '../core/studio.js?v=20260807-02';
import { instrumentView } from '../view/instrument-presets.js?v=20260807-02';
import { leaveInstrumentView } from '../view/instrument-view.js?v=20260807-02';
import { resetMascotPose, setDancing } from './pose.js?v=20260807-02';
import { mascotMove } from './state.js?v=20260807-02';
import {
  MASCOT_DEFAULTS,
  MASCOT_HEIGHT_RANGE,
  MASCOT_WIDTH_RANGE,
  ...
  mascotCfg,
  saveMascotConfig,
} from './appearance.js?v=20260807-02';
