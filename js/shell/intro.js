...
import { params, prefersReducedMotion } from '../core/quality.js?v=20260813-15';
import { isFreeCamera } from '../core/camera-mode.js?v=20260813-15';
import { camera, controls, CAM_START, CAM_END, TARGET } from '../view/rig.js?v=20260813-15';
import { ui, audio, mic, mascot } from '../core/studio.js?v=20260813-15';
import { instrumentView } from '../view/instrument-presets.js?v=20260813-15';
import { glowMesh, unglowMesh } from '../view/emissive.js?v=20260813-15';
import { mobileFollow } from '../view/mobile-controls.js?v=20260813-15';
import { mascotMove } from '../mascot/state.js?v=20260813-15';
import { giftPending } from '../mascot/reveal.js?v=20260813-15';
import { play } from '../play/state.js?v=20260813-15';
import { vowelAt } from '../play/voice.js?v=20260813-15';
import {
  LOOP_MAX_SECONDS,
  loop,
  positiveModulo,
...
import { clearGuitarInteractionState } from '../play/chord-wheel.js?v=20260813-15';
import { resyncGroove } from '../play/groove.js?v=20260813-15';
import { releaseAllHeldPianoNotes } from '../play/piano-notes.js?v=20260813-15';
import { releaseKeyboardVocal } from '../play/mixer.js?v=20260813-15';
import { trackOnce } from '../core/analytics.js?v=20260813-15';
