...
import { params, prefersReducedMotion } from '../core/quality.js?v=20260905-05';
import { isFreeCamera } from '../core/camera-mode.js?v=20260905-05';
import { camera, controls, CAM_START, CAM_END, TARGET } from '../view/rig.js?v=20260905-05';
import { ui, audio, mic, mascot } from '../core/studio.js?v=20260905-05';
import { instrumentView } from '../view/instrument-presets.js?v=20260905-05';
import { glowMesh, unglowMesh } from '../view/emissive.js?v=20260905-05';
import { mobileFollow } from '../view/mobile-controls.js?v=20260905-05';
import { mascotMove } from '../mascot/state.js?v=20260905-05';
import { giftPending } from '../mascot/reveal.js?v=20260905-05';
import { play } from '../play/state.js?v=20260905-05';
import { vowelAt } from '../play/voice.js?v=20260905-05';
import {
  LOOP_MAX_SECONDS,
  loop,
  positiveModulo,
...
import { clearGuitarInteractionState } from '../play/chord-wheel.js?v=20260905-05';
import { resyncGroove } from '../play/groove.js?v=20260905-05';
import { releaseAllHeldPianoNotes } from '../play/piano-notes.js?v=20260905-05';
import { releaseKeyboardVocal } from '../play/mixer.js?v=20260905-05';
