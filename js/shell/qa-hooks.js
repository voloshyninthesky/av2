...
import { params } from '../core/quality.js?v=20260806-19';
import { session } from '../core/session.js?v=20260806-19';
import { renderer, scene, camera, controls } from '../view/rig.js?v=20260806-19';
import { mascot, guitar, interactables } from '../core/studio.js?v=20260806-19';
import { INSTRUMENT_VIEW_PRESETS, instrumentView } from '../view/instrument-presets.js?v=20260806-19';
import { raycaster } from '../view/pick.js?v=20260806-19';
import { mascotMove } from '../mascot/state.js?v=20260806-19';
import { setDancing } from '../mascot/pose.js?v=20260806-19';
import { leaveInstrumentView, requestInstrumentView } from '../view/instrument-view.js?v=20260806-19';
import { addVibe } from '../play/vibe.js?v=20260806-19';
import { composer } from './postfx.js?v=20260806-19';
