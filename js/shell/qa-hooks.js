...
import { params } from '../core/quality.js?v=20260813-25';
import { session } from '../core/session.js?v=20260813-25';
import { renderer, scene, camera, controls } from '../view/rig.js?v=20260813-25';
import { ui, mascot, guitar, interactables } from '../core/studio.js?v=20260813-25';
import { INSTRUMENT_VIEW_PRESETS, instrumentView } from '../view/instrument-presets.js?v=20260813-25';
import { raycaster } from '../view/pick.js?v=20260813-25';
import { mascotMove } from '../mascot/state.js?v=20260813-25';
import { setDancing } from '../mascot/pose.js?v=20260813-25';
import { leaveInstrumentView, requestInstrumentView } from '../view/instrument-view.js?v=20260813-25';
import { addVibe, VIBE_NOTE_GAIN } from '../play/vibe.js?v=20260813-25';
import { giftReveal, skipGiftCeremony, forceGiftTier } from '../mascot/reveal.js?v=20260813-25';
import { drawMascotGift } from '../mascot/gift.js?v=20260813-25';
import { composer } from './postfx.js?v=20260813-25';
