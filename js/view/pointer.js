...
import { isQuickGuitarTap } from '../guitar-gestures.js?v=20260809-09';
import { canvas, camera, controls } from './rig.js?v=20260809-09';
import { ui, drums, piano, guitar, mic, instruments, interactables } from '../core/studio.js?v=20260809-09';
import { instrumentView } from './instrument-presets.js?v=20260809-09';
import { raycaster, pointer } from './pick.js?v=20260809-09';
import { glowMesh, unglowMesh } from './emissive.js?v=20260809-09';
import { walkMascotToInstrument } from './mobile-controls.js?v=20260809-09';
import { resetBrowserPageZoom } from './viewport.js?v=20260809-09';
import { activePointers } from '../play/state.js?v=20260809-09';
import {
  currentGuitarShape,
  fireGuitarStrum,
  pluckGuitarString,
