...
import { isMobileGameMode } from '../core/quality.js?v=20260813-18';
import { isQuickGuitarTap } from '../guitar-gestures.js?v=20260813-18';
import { canvas, camera, controls } from './rig.js?v=20260813-18';
import { ui, drums, piano, guitar, mic, instruments, interactables } from '../core/studio.js?v=20260813-18';
import { instrumentView } from './instrument-presets.js?v=20260813-18';
import { raycaster, pointer } from './pick.js?v=20260813-18';
import { glowMesh, unglowMesh } from './emissive.js?v=20260813-18';
import { walkMascotToInstrument } from './mobile-controls.js?v=20260813-18';
import { resetBrowserPageZoom } from './viewport.js?v=20260813-18';
import { DOUBLE_TAP_EXEMPT, judgeDoubleTap } from '../core/gesture-guards.js?v=20260813-18';
import { activePointers } from '../play/state.js?v=20260813-18';
import {
  currentGuitarShape,
  fireGuitarStrum,
  pluckGuitarString,
