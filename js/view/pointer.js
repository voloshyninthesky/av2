...
import { isMobileGameMode } from '../core/quality.js?v=20260813-20';
import { isQuickGuitarTap } from '../guitar-gestures.js?v=20260813-20';
import { canvas, camera, controls } from './rig.js?v=20260813-20';
import { ui, drums, piano, guitar, mic, instruments, interactables } from '../core/studio.js?v=20260813-20';
import { instrumentView } from './instrument-presets.js?v=20260813-20';
import { raycaster, pointer } from './pick.js?v=20260813-20';
import { glowMesh, unglowMesh } from './emissive.js?v=20260813-20';
import { walkMascotToInstrument } from './mobile-controls.js?v=20260813-20';
import { resetBrowserPageZoom } from './viewport.js?v=20260813-20';
import { DOUBLE_TAP_EXEMPT, judgeDoubleTap } from '../core/gesture-guards.js?v=20260813-20';
import { activePointers } from '../play/state.js?v=20260813-20';
import {
  currentGuitarShape,
  fireGuitarStrum,
  pluckGuitarString,
