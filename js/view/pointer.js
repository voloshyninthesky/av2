...
import { isMobileGameMode } from '../core/quality.js?v=20260807-05';
import { isQuickGuitarTap } from '../guitar-gestures.js?v=20260807-05';
import { canvas, camera, controls } from './rig.js?v=20260807-05';
import { ui, drums, piano, guitar, mic, instruments, interactables } from '../core/studio.js?v=20260807-05';
import { instrumentView } from './instrument-presets.js?v=20260807-05';
import { raycaster, pointer } from './pick.js?v=20260807-05';
import { glowMesh, unglowMesh } from './emissive.js?v=20260807-05';
import { walkMascotToInstrument } from './mobile-controls.js?v=20260807-05';
import { resetBrowserPageZoom } from './viewport.js?v=20260807-05';
import { activePointers } from '../play/state.js?v=20260807-05';
import {
  currentGuitarShape,
  fireGuitarStrum,
  pluckGuitarString,
