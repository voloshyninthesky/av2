...
import { prefersReducedMotion, isLowEndMobileGameMode } from '../core/quality.js?v=20260813-26';
import {
  renderer,
  camera,
  controls,
...
} from './rig.js?v=20260813-26';
import { ui } from '../core/studio.js?v=20260813-26';
import { invalidateSlideshowNavLayout } from '../scene/slideshow.js?v=20260813-26';
import { INSTRUMENT_VIEW_PRESETS, instrumentView } from './instrument-presets.js?v=20260813-26';
import { instrumentViewFrame } from './focus-frame.js?v=20260813-26';
import { applyFocusedControlLimits, syncControlsAtInstrumentFrame } from './instrument-view.js?v=20260813-26';
import { syncMobileInstrumentChrome } from './mobile-controls.js?v=20260813-26';
