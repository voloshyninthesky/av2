...
import { prefersReducedMotion, isLowEndMobileGameMode } from '../core/quality.js?v=20260808-07';
import {
  renderer,
  camera,
  controls,
...
} from './rig.js?v=20260808-07';
import { ui } from '../core/studio.js?v=20260808-07';
import { invalidateSlideshowNavLayout } from '../scene/slideshow.js?v=20260808-07';
import { INSTRUMENT_VIEW_PRESETS, instrumentView } from './instrument-presets.js?v=20260808-07';
import { instrumentViewFrame } from './focus-frame.js?v=20260808-07';
import { applyFocusedControlLimits, syncControlsAtInstrumentFrame } from './instrument-view.js?v=20260808-07';
import { syncMobileInstrumentChrome } from './mobile-controls.js?v=20260808-07';
import { mascotEditor, queueMascotRefit } from '../mascot/editor.js?v=20260808-07';
