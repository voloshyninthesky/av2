...
import { prefersReducedMotion, isLowEndMobileGameMode } from '../core/quality.js?v=20260901-01';
import {
  renderer,
  camera,
  controls,
...
} from './rig.js?v=20260901-01';
import { ui } from '../core/studio.js?v=20260901-01';
import { invalidateSlideshowNavLayout } from '../scene/slideshow.js?v=20260901-01';
import { INSTRUMENT_VIEW_PRESETS, instrumentView } from './instrument-presets.js?v=20260901-01';
import { instrumentViewFrame } from './focus-frame.js?v=20260901-01';
import { applyFocusedControlLimits, syncControlsAtInstrumentFrame } from './instrument-view.js?v=20260901-01';
import { syncMobileInstrumentChrome } from './mobile-controls.js?v=20260901-01';
