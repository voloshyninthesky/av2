...
import { AudioEngine } from '../audio.js?v=20260809-05';
import { buildDrumKit } from '../instruments/drums.js?v=20260809-05';
import { buildPiano } from '../instruments/piano.js?v=20260809-05';
import { buildGuitar } from '../instruments/guitar.js?v=20260809-05';
import { buildMic } from '../instruments/mic.js?v=20260809-05';
import { UI } from '../ui.js?v=20260809-05';
import { scene, renderer } from '../view/rig.js?v=20260809-05';
import {
  adaptiveQualityScene,
  applyStageLightLevel,
  stageLightLevel,
} from './quality.js?v=20260809-05';
import { buildStage } from '../scene/stage.js?v=20260809-05';
import { buildSigns } from '../scene/signs.js?v=20260809-05';
import {
  installStageEnvironment,
  buildLights,
  buildDust,
  applyLowMobileSceneBudget,
} from '../scene/lighting.js?v=20260809-05';
import { buildMascot, makeMascotPointer } from '../scene/mascot-model.js?v=20260809-05';
import { Fireworks, NoteBursts, bumpHitPulse } from '../scene/effects.js?v=20260809-05';
import {
  MASCOT_BASE_SCALE,
  MASCOT_DEFAULTS,
  MASCOT_HAIR_STYLES,
  ...
  mascotCfg,
} from '../mascot/appearance.js?v=20260809-05';
