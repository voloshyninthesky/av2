...
import { AudioEngine } from '../audio.js?v=20260906-01';
import { buildDrumKit } from '../instruments/drums.js?v=20260906-01';
import { buildPiano } from '../instruments/piano.js?v=20260906-01';
import { buildGuitar } from '../instruments/guitar.js?v=20260906-01';
import { buildMic } from '../instruments/mic.js?v=20260906-01';
import { UI } from '../ui.js?v=20260906-01';
import { scene, renderer } from '../view/rig.js?v=20260906-01';
import {
  adaptiveQualityScene,
  applyStageLightLevel,
  stageLightLevel,
} from './quality.js?v=20260906-01';
import { buildStage } from '../scene/stage.js?v=20260906-01';
import { buildSigns } from '../scene/signs.js?v=20260906-01';
import {
  installStageEnvironment,
  buildLights,
  buildDust,
  applyLowMobileSceneBudget,
} from '../scene/lighting.js?v=20260906-01';
import { buildMascot, makeMascotPointer } from '../scene/mascot-model.js?v=20260906-01';
import { buildMascotCompanion } from '../scene/mascot-companion.js?v=20260906-01';
import { buildGiftWardrobe } from '../scene/gift-wardrobe.js?v=20260906-01';
import { Fireworks, NoteBursts, bumpHitPulse } from '../scene/effects.js?v=20260906-01';
import {
  MASCOT_BASE_SCALE,
  MASCOT_DEFAULTS,
  MASCOT_HAIR_STYLES,
  ...
  MASCOT_SMILES,
  mascotCfg,
} from '../mascot/appearance.js?v=20260906-01';
import { GIFT_TIERS_BY_ID } from '../mascot/gift.js?v=20260906-01';
