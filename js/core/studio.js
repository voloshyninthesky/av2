...
import { AudioEngine } from '../audio.js?v=20260906-02';
import { buildDrumKit } from '../instruments/drums.js?v=20260906-02';
import { buildPiano } from '../instruments/piano.js?v=20260906-02';
import { buildGuitar } from '../instruments/guitar.js?v=20260906-02';
import { buildMic } from '../instruments/mic.js?v=20260906-02';
import { UI } from '../ui.js?v=20260906-02';
import { scene, renderer } from '../view/rig.js?v=20260906-02';
import {
  adaptiveQualityScene,
  applyStageLightLevel,
  stageLightLevel,
} from './quality.js?v=20260906-02';
import { buildStage } from '../scene/stage.js?v=20260906-02';
import { buildSigns } from '../scene/signs.js?v=20260906-02';
import {
  installStageEnvironment,
  buildLights,
  buildDust,
  applyLowMobileSceneBudget,
} from '../scene/lighting.js?v=20260906-02';
import { buildMascot, makeMascotPointer } from '../scene/mascot-model.js?v=20260906-02';
import { buildMascotCompanion } from '../scene/mascot-companion.js?v=20260906-02';
import { buildGiftWardrobe } from '../scene/gift-wardrobe.js?v=20260906-02';
import { Fireworks, NoteBursts, bumpHitPulse } from '../scene/effects.js?v=20260906-02';
import {
  MASCOT_BASE_SCALE,
  MASCOT_DEFAULTS,
  MASCOT_HAIR_STYLES,
  ...
  MASCOT_SMILES,
  mascotCfg,
} from '../mascot/appearance.js?v=20260906-02';
import { GIFT_TIERS_BY_ID } from '../mascot/gift.js?v=20260906-02';
...
// The tier's companion bird (one species per marked tier). A child of
...
export function applyMascotConfig() {
  ...
  // The rarity's persistent presence: the companion bird and its halo. The
  // bird lands on the character as actually built — the crown is the hair
  // cap, the bare scalp or the headphone band — and keeps one world size
  // whatever the height / build draw did to the body underneath it.
  const tier = GIFT_TIERS_BY_ID[mascotCfg.tier] ?? GIFT_TIERS_BY_ID.common;
  for (const [id, dress] of Object.entries(cu.tierDress)) dress.visible = id === tier.id;
  cu.badge.visible = tier.id === 'common';
  mascotCompanion.setTier(tier, {
    crownY: mascot.perches.crownY(style.cap, mascotCfg.accessory),
    shoulder: mascot.perches.shoulder,
    build: { width: mascotCfg.width / 100, height: mascotCfg.height / 100 },
  });
  applyMascotScale();
}
