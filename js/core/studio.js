...
import { buildDrumKit } from '../instruments/drums.js?v=20260806-18';
import { buildPiano } from '../instruments/piano.js?v=20260806-18';
import { buildGuitar } from '../instruments/guitar.js?v=20260806-18';
import { buildMic } from '../instruments/mic.js?v=20260806-18';
import { UI } from '../ui.js?v=20260806-18';
import { scene, renderer } from '../view/rig.js?v=20260806-18';
import {
  adaptiveQualityScene,
  applyStageLightLevel,
  stageLightLevel,
} from './quality.js?v=20260806-18';
import { buildStage } from '../scene/stage.js?v=20260806-18';
import {
  installStageEnvironment,
  buildLights,
  buildDust,
  applyLowMobileSceneBudget,
} from '../scene/lighting.js?v=20260806-18';
import { buildMascot, makeMascotPointer } from '../scene/mascot-model.js?v=20260806-18';
import { Fireworks, NoteBursts, bumpHitPulse } from '../scene/effects.js?v=20260806-18';
import {
  MASCOT_BASE_SCALE,
  MASCOT_DEFAULTS,
  MASCOT_HAIR_STYLES,
  ...
  mascotCfg,
} from '../mascot/appearance.js?v=20260806-18';
