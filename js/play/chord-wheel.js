...
// ============================================================
import { piano } from '../core/studio.js?v=20260901-01';
import { isQuickGuitarTap } from '../guitar-gestures.js?v=20260901-01';
import { canvas } from '../view/rig.js?v=20260901-01';
import { play, activePointers } from './state.js?v=20260901-01';
import {
  GUITAR_CHORDS,
  fifthIndexOf,
  keyDegrees,
...
import {
  ...
  stepStageKey,
  toggleStageMode,
} from './key.js?v=20260901-01';
import { degreeKeyLabel, setKeyChords } from './guitar.js?v=20260901-01';
