...
// ============================================================
import { piano } from '../core/studio.js?v=20260813-25';
import { isQuickGuitarTap } from '../guitar-gestures.js?v=20260813-25';
import { canvas } from '../view/rig.js?v=20260813-25';
import { play, activePointers } from './state.js?v=20260813-25';
import {
  GUITAR_CHORDS,
  fifthIndexOf,
  keyDegrees,
...
import {
  ...
  stepStageKey,
  toggleStageMode,
} from './key.js?v=20260813-25';
import { degreeKeyLabel, setKeyChords } from './guitar.js?v=20260813-25';
