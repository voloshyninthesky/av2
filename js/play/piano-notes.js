...
import { ui, audio, piano, whiteKeys, blackKeys } from '../core/studio.js?v=20260807-03';
import { instrumentView } from '../view/instrument-presets.js?v=20260807-03';
import { raycaster, stageWalkPlane } from '../view/pick.js?v=20260807-03';
import { play, heldPianoNotes, keyboardPianoNotes } from './state.js?v=20260807-03';
import { noteKeyboardJamActivity } from './vibe.js?v=20260807-03';
import {
  LOOP_MAX_SECONDS,
  loop,
  captureLoopEvent,
  ...
  clearRecordedLoop,
  toggleLoopRecording,
} from './loop.js?v=20260807-03';
import { GUITAR_KEY_CHORDS, fireGuitarStrum } from './guitar.js?v=20260807-03';
import { syncChordPadHeld, deferHeldLoopEventPlayback, playVocalNote } from './pads.js?v=20260807-03';
