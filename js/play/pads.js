...
// ============================================================
import { ui, audio, guitar, mic } from '../core/studio.js?v=20260809-06';
import { isQuickGuitarTap } from '../guitar-gestures.js?v=20260809-06';
import { canvas } from '../view/rig.js?v=20260809-06';
import { play, activePointers } from './state.js?v=20260809-06';
import {
  CHORD_QUALITIES,
  CHORD_ROOTS,
  GUITAR_CHORDS,
  ...
  setPadChord,
  slotKeyLabel,
} from './guitar.js?v=20260809-06';
import { addVibe } from './vibe.js?v=20260809-06';
import { LOOP_MAX_SECONDS, loop, captureLoopEvent, playMusicalEvent } from './loop.js?v=20260809-06';
