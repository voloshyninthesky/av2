...
import './core/errlog.js?v=20260809-10';
import './core/telegram.js?v=20260809-10';
import { session, easeInOut } from './core/session.js?v=20260809-10';
import { mascotMove, dance } from './mascot/state.js?v=20260809-10';
import { play } from './play/state.js?v=20260809-10';
import { raycaster, pointer, stageWalkPlane } from './view/pick.js?v=20260809-10';
import './shell/qa-hooks.js?v=20260809-10';
import {
  chipFor,
  queuePriceChip,
  ...
  initVibe,
} from './play/vibe.js?v=20260809-10';
import {
  updateLoopProgress,
  initLoopPedal,
...
import {
  ...
  initPads,
} from './play/pads.js?v=20260809-10';
import {
...
import {
  ...
  qualityWarmup,
  initPostfx,
} from './shell/postfx.js?v=20260809-10';
import {
  FLY_DUR,
  shouldSkipIntro,
  startOnboard,
  ...
  initIntro,
} from './shell/intro.js?v=20260809-10';
import {
  closeSoundMixer,
  releaseKeyboardVocal,
  beginKeyboardVocal,
  initMixer,
} from './play/mixer.js?v=20260809-10';
import { mascotEditor, queueMascotRefit, mascotCam, initMascotEditor } from './mascot/editor.js?v=20260809-10';
import {
  params,
...
import {
  ...
  CAM_END,
  TARGET,
} from './view/rig.js?v=20260809-10';
import {
  ui,
  audio,
  stage,
...
import { spotHeads, applyLowMobileSceneBudget } from './scene/lighting.js?v=20260809-10';
import {
  instrumentView,
} from './view/instrument-presets.js?v=20260809-10';
import {
  updateInstrumentViewCamera,
  initInstrumentView,
} from './view/instrument-view.js?v=20260809-10';
import {
  setDancing,
} from './mascot/pose.js?v=20260809-10';
import {
  PHOTO_SLIDES_ENABLED,
  loadSlideTextures,
  updateSlideshow,
  updateSlideshowNavLayout,
} from './scene/slideshow.js?v=20260809-10';
import { hitPulse, bumpHitPulse } from './scene/effects.js?v=20260809-10';
import {
  setGlow,
  isInstrumentCloseUp,
  onPointerMove,
  ...
  canKeyboardJamPlay,
  syncOrbitZoom,
} from './view/pointer.js?v=20260809-10';
import {
  syncViewportMeta,
  ...
  initViewport,
} from './view/viewport.js?v=20260809-10';
import {
  ...
  initMobileControls,
} from './view/mobile-controls.js?v=20260809-10';
import { updateMascot, updateMascotEditorPreview } from './mascot/update.js?v=20260809-10';
import { initSigns, revealSigns } from './shell/signs.js?v=20260809-10';
import { updateSigns } from './scene/signs.js?v=20260809-10';
