...
import './core/errlog.js?v=20260813-15';
import './core/telegram.js?v=20260813-15';
import { session, easeInOut } from './core/session.js?v=20260813-15';
import { mascotMove, dance } from './mascot/state.js?v=20260813-15';
import { play } from './play/state.js?v=20260813-15';
import { raycaster, pointer, stageWalkPlane } from './view/pick.js?v=20260813-15';
import './shell/qa-hooks.js?v=20260813-15';
import {
  chipFor,
  queuePriceChip,
  ...
  initVibe,
} from './play/vibe.js?v=20260813-15';
import {
  loop,
  updateLoopProgress,
  initLoopPedal,
} from './play/loop.js?v=20260813-15';
import {
  currentGuitarChordName,
  allGuitarPitches,
  initGuitarPlay,
} from './play/guitar.js?v=20260813-15';
import {
  captureHeldVocalIntoLoop,
  finishHeldLoopCapture,
  initPads,
} from './play/pads.js?v=20260813-15';
import {
  showRibbon,
  hideRibbon,
  stopRibbonVoice,
  initRibbon,
} from './play/ribbon.js?v=20260813-15';
import {
  showChordWheel,
  hideChordWheel,
  ...
  initChordWheel,
} from './play/chord-wheel.js?v=20260813-15';
import {
  showGrooveWheel,
  hideGrooveWheel,
  stopGroove,
  ...
  grooveDownbeatAt,
  initGroove,
} from './play/groove.js?v=20260813-15';
import {
  beginHeldPianoNote,
  ...
  initPianoNotes,
} from './play/piano-notes.js?v=20260813-15';
import {
  composer,
  bloomPass,
  initPostprocessing,
  ...
  qualityWarmup,
  initPostfx,
} from './shell/postfx.js?v=20260813-15';
import {
  FLY_DUR,
  shouldSkipIntro,
  startOnboard,
  ...
  initIntro,
} from './shell/intro.js?v=20260813-15';
import {
  closeSoundMixer,
  releaseKeyboardVocal,
  beginKeyboardVocal,
  initMixer,
} from './play/mixer.js?v=20260813-15';
import {
  giftCam,
  queueGiftRefit,
  updateGiftReveal,
  ...
  giftApproachFraming,
  initMascotGift,
} from './mascot/reveal.js?v=20260813-15';
import {
  params,
  ...
  stageAmbience,
  stageLightLevel,
} from './core/quality.js?v=20260813-15';
import { onCameraModeChange } from './core/camera-mode.js?v=20260813-15';
import {
  canvas,
  renderer,
  scene,
  ...
  CAM_END,
  TARGET,
} from './view/rig.js?v=20260813-15';
import {
  ui,
  audio,
  stage,
  ...
  instruments,
  interactables,
} from './core/studio.js?v=20260813-15';
import { spotHeads, applyLowMobileSceneBudget } from './scene/lighting.js?v=20260813-15';
import {
  instrumentView,
} from './view/instrument-presets.js?v=20260813-15';
import {
  updateInstrumentViewCamera,
  initInstrumentView,
} from './view/instrument-view.js?v=20260813-15';
import {
  setDancing,
} from './mascot/pose.js?v=20260813-15';
import {
  PHOTO_SLIDES_ENABLED,
  loadSlideTextures,
  updateSlideshow,
  updateSlideshowNavLayout,
} from './scene/slideshow.js?v=20260813-15';
import { hitPulse, bumpHitPulse } from './scene/effects.js?v=20260813-15';
import {
  setGlow,
  isInstrumentCloseUp,
  onPointerMove,
  ...
  canKeyboardJamPlay,
  syncOrbitZoom,
} from './view/pointer.js?v=20260813-15';
import {
  syncViewportMeta,
  ...
  initViewport,
} from './view/viewport.js?v=20260813-15';
import {
  ...
  initMobileControls,
} from './view/mobile-controls.js?v=20260813-15';
import { updateMascot } from './mascot/update.js?v=20260813-15';
import { initSigns, revealSigns } from './shell/signs.js?v=20260813-15';
import { updateSigns } from './scene/signs.js?v=20260813-15';
