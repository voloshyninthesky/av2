...
import './core/errlog.js?v=20260808-02';
import './core/telegram.js?v=20260808-02';
import { session, easeInOut } from './core/session.js?v=20260808-02';
import { mascotMove, dance } from './mascot/state.js?v=20260808-02';
import { play } from './play/state.js?v=20260808-02';
import { raycaster, pointer, stageWalkPlane } from './view/pick.js?v=20260808-02';
import './shell/qa-hooks.js?v=20260808-02';
import {
  chipFor,
  queuePriceChip,
  ...
  initVibe,
} from './play/vibe.js?v=20260808-02';
import {
  updateLoopProgress,
  initLoopPedal,
} from './play/loop.js?v=20260808-02';
import {
  currentGuitarChordName,
  allGuitarPitches,
  initGuitarPlay,
} from './play/guitar.js?v=20260808-02';
import {
  showVocalPad,
  hideVocalPad,
  showChordPad,
  ...
  initPads,
} from './play/pads.js?v=20260808-02';
import {
  ...
  initPianoNotes,
} from './play/piano-notes.js?v=20260808-02';
import {
  composer,
  initPostprocessing,
  updateMobileQualityProbe,
  initPostfx,
} from './shell/postfx.js?v=20260808-02';
import {
  FLY_DUR,
  shouldSkipIntro,
  startOnboard,
  ...
  initIntro,
} from './shell/intro.js?v=20260808-02';
import {
  closeSoundMixer,
  releaseKeyboardVocal,
  beginKeyboardVocal,
  initMixer,
} from './play/mixer.js?v=20260808-02';
import { mascotEditor, queueMascotRefit, mascotCam, initMascotEditor } from './mascot/editor.js?v=20260808-02';
import {
  params,
...
import {
  ...
  CAM_END,
  TARGET,
} from './view/rig.js?v=20260808-02';
import {
  ui,
  audio,
  stage,
  ...
  instruments,
  interactables,
} from './core/studio.js?v=20260808-02';
import { spotHeads, applyLowMobileSceneBudget } from './scene/lighting.js?v=20260808-02';
import {
  instrumentView,
} from './view/instrument-presets.js?v=20260808-02';
import {
  updateInstrumentViewCamera,
  initInstrumentView,
} from './view/instrument-view.js?v=20260808-02';
import {
  setDancing,
} from './mascot/pose.js?v=20260808-02';
import {
  PHOTO_SLIDES_ENABLED,
  loadSlideTextures,
  updateSlideshow,
  updateSlideshowNavLayout,
} from './scene/slideshow.js?v=20260808-02';
import { hitPulse, bumpHitPulse } from './scene/effects.js?v=20260808-02';
import {
  setGlow,
  isInstrumentCloseUp,
  onPointerMove,
  ...
  canKeyboardJamPlay,
  syncOrbitZoom,
} from './view/pointer.js?v=20260808-02';
import {
  syncViewportMeta,
  ...
  initViewport,
} from './view/viewport.js?v=20260808-02';
import {
  ...
  initMobileControls,
} from './view/mobile-controls.js?v=20260808-02';
import { updateMascot, updateMascotEditorPreview } from './mascot/update.js?v=20260808-02';
import { initSigns, revealSigns } from './shell/signs.js?v=20260808-02';
import { updateSigns } from './scene/signs.js?v=20260808-02';
