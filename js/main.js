...
import './core/errlog.js?v=20260813-05';
import './core/telegram.js?v=20260813-05';
import { session, easeInOut } from './core/session.js?v=20260813-05';
import { mascotMove, dance } from './mascot/state.js?v=20260813-05';
import { play } from './play/state.js?v=20260813-05';
import { raycaster, pointer, stageWalkPlane } from './view/pick.js?v=20260813-05';
import './shell/qa-hooks.js?v=20260813-05';
import {
  chipFor,
  queuePriceChip,
  ...
  initVibe,
} from './play/vibe.js?v=20260813-05';
import {
  updateLoopProgress,
  initLoopPedal,
} from './play/loop.js?v=20260813-05';
import {
  currentGuitarChordName,
  allGuitarPitches,
  initGuitarPlay,
} from './play/guitar.js?v=20260813-05';
import {
  showVocalPad,
  hideVocalPad,
  ...
  initPads,
} from './play/pads.js?v=20260813-05';
import {
  showChordWheel,
  hideChordWheel,
  ...
  initChordWheel,
} from './play/chord-wheel.js?v=20260813-05';
import {
  beginHeldPianoNote,
...
import {
  ...
  qualityWarmup,
  initPostfx,
} from './shell/postfx.js?v=20260813-05';
import {
  FLY_DUR,
  shouldSkipIntro,
  startOnboard,
  ...
  initIntro,
} from './shell/intro.js?v=20260813-05';
import {
  closeSoundMixer,
...
import {
  ...
  stageAmbience,
  stageLightLevel,
} from './core/quality.js?v=20260813-05';
import { onCameraModeChange } from './core/camera-mode.js?v=20260813-05';
import {
  canvas,
  renderer,
  scene,
  ...
  CAM_END,
  TARGET,
} from './view/rig.js?v=20260813-05';
import {
  ui,
  audio,
  stage,
...
import { spotHeads, applyLowMobileSceneBudget } from './scene/lighting.js?v=20260813-05';
import {
  instrumentView,
} from './view/instrument-presets.js?v=20260813-05';
import {
  updateInstrumentViewCamera,
  initInstrumentView,
} from './view/instrument-view.js?v=20260813-05';
import {
  setDancing,
} from './mascot/pose.js?v=20260813-05';
import {
  PHOTO_SLIDES_ENABLED,
  loadSlideTextures,
  updateSlideshow,
  updateSlideshowNavLayout,
} from './scene/slideshow.js?v=20260813-05';
import { hitPulse, bumpHitPulse } from './scene/effects.js?v=20260813-05';
import {
  setGlow,
  isInstrumentCloseUp,
  onPointerMove,
  ...
  canKeyboardJamPlay,
  syncOrbitZoom,
} from './view/pointer.js?v=20260813-05';
import {
  syncViewportMeta,
  ...
  initViewport,
} from './view/viewport.js?v=20260813-05';
import {
