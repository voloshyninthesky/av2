...
- **Credit:** «made by @vadymbek» maker’s mark mounted on the lower front stage → https://vadymbek.top
...
- Smaller physical **made by @vadymbek** maker’s mark mounted on the lower front stage beam (clickable link hit target). It is immediately visible from the first fall frame, remains fixed in scene space, and never follows the camera like a title.
