...
- **Credit:** a low-contrast engraved `vadymbek` maker's mark in the front-right stage floorboards → https://vadymbek.top  
...
- Subtle engraved **vadymbek** maker's mark in the front-right stage floorboards (clickable link hit target); it reads as an environmental signature in the corner of the stage, not an explicit credit banner.
