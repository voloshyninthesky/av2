...
- A live **СВІТЛО** dimmer in the same modal scales stage lights, footlight emissives, and beam opacity from **0–130%** without a reload. The value persists in `localStorage` key `av2.lights.v1` (default `100`) and stays independent of Glamour / Pixel / Auto.
