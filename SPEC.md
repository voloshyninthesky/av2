...
- A live **СВІТЛО** side control (beside zoom) scales stage lights, footlight emissives, and beam opacity from **0–130%** without a reload. The value persists in `localStorage` key `av2.lights.v1` (default `50`) and stays independent of Glamour / Pixel / Auto.
