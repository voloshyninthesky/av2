...
- A live horizontal **СВІТЛО** control under the volume button scales stage lights, footlight emissives, and beam opacity from **0–130%** without a reload. The value persists in `localStorage` key `av2.lights.v1` (default `67`) and stays independent of Glamour / Pixel / Auto.
